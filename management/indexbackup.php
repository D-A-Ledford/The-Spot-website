...
if(isset ($_POST['submit']))
{
    ...
    else
    {
        ...
        if ($count < 1)
        {
            echo  "<p style='color: red' class='error'>*The username you entered does not match any account.</p>";
        }
        else
        {
            $row = $s->fetch();
			...
			*/
            ...
            if ($count2 <1)
            {
                echo "<p style='color: red' class='error'>*The username and password combination you entered is incorrect.</p>";
            }
            else
            {
