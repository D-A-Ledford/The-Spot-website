...
//Select statement to determine the category for this page.	
	$sqlselectc = "SELECT * from productcategory WHERE productcategoryid = 4";
...
?> 		
		...
		<div class="options">
			...
			<div class="col-4"><img class="product-img" src ="<?PHP echo $rowp['productimg'] ?>" alt="Drinks" width= "150px" height="120px"></div><!--end button-->
			<div class="col-8">
